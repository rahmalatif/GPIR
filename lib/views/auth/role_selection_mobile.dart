...
class RoleSelectionMobileView extends StatelessWidget {
  const RoleSelectionMobileView({super.key});
        ...
        child: Center(
          child: Column(
            children: [
              ...
              _selectButton(context, "🧑‍🏫 Teacher Assistant", "ta"),
              const SizedBox(height: 30),

              _selectButton(context, "🧾 Admin", "admin"),
              const SizedBox(height: 30),

              _selectButton(context, "👨‍💼 Manager", "manager"),
              const SizedBox(height: 30),
