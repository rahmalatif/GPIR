...
class SendIdeaToDrMobileView extends StatefulWidget {
  final Doctor doctor;
  final ProjectIdea projectIdea;

  const SendIdeaToDrMobileView({
    super.key,
  ...
  @override
  State<SendIdeaToDrMobileView> createState() => _SendIdeaToDrMobileViewState();
}

class _SendIdeaToDrMobileViewState extends State<SendIdeaToDrMobileView> {
  ...
  String get draftNameKey => "draft_name_${widget.projectIdea.title}";

  String get draftDescKey => "draft_desc_${widget.projectIdea.description}";
  ...
  Future<void> loadDraft() async {
    ...
    nameController.text = prefs.getString(draftNameKey) ?? nameController.text;
